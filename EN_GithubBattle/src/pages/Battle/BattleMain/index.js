...
import styles from './BattleMain.less'

import Player from './children/Player'

class BattleMain extends Component {
  render() {
    const { bgStyle } = this.props;

    return (
      <div id="battle" className={bgStyle === 'light' ? '' : styles['text-dark']}>
        <div className="instructions-container">
          ...
          >
            <div className={styles['intro-content']}>
              <h3 className={styles['intro-title']}>Enter two Github users</h3>
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
                ...
                height="140" 
                width="140"
                className={`${styles['intro-svg']} ${bgStyle === 'light' ? '' : styles['intro-svg-dark']}`}
            ...
            <div className={styles['intro-content']}>
              <h3 className={styles['intro-title']}>Battle</h3>
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
            ...
            <div className={styles['intro-content']}>
              <h3 className={styles['intro-title']}>See the winner</h3>
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
